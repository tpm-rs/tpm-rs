...
pub trait Drbg: Sized {
    ...
    fn next_u32(&mut self, additional_input: &[u8]) -> Result<u32, Self::Error>;
    ...
    /// 2. DRBG requires reseeding.
    /// 3. Internal Errors in case of hardware drbg.
    fn next_u64(&mut self, additional_input: &[u8]) -> Result<u64, Self::Error>;
    ...
    /// 2. DRBG requires reseeding.
    /// 3. Internal Errors in case of hardware drbg.
    fn fill_bytes(&mut self, additional_input: &[u8], dest: &mut [u8]) -> Result<(), Self::Error>;
